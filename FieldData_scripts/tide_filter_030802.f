*      TIDE FILTER
*      PROGRAM TO FILTER AND WRITE OUT FILTERED TIDES
...
*	
*	ENTER THE FACTOR BY WHICH WATER SURFACE ELEVATIONS WILL BE REDUCED/INCREASED
*	UPON FILTERING (EXAMPLE: 0.9 FOR 90% MAGNITUDE)
*	ENTER 1 TO LEAVE TIDES UNCHANGED
*
 	write(*,*) '   what is the reduction/increase factor .. '
 	read(*,*) reduct
...
*
*
*	ENTER FILENAME CONTAINING TIDES TO BE FILTERED
*	FIRST COLUMN SHOULD CONTAIN TIMES, SECOND COLUMN SHOULD CONTAIN TIDES
*
...
**
C        open(25,file='tides',form='formatted',status='unknown')
C        write(25,*)'   n     tide     sata     fsata     data2  avez   time '
*
	do n=1,nval
...
C       write(25,26) n,tide(n),sata(n),fsata(n),data2(n),avez,time(n)
C26	format(i6,3x,f7.3,2x,f7.3,2x,f7.3,2x,f7.3,4x,f7.3,f10.3)
        end do
C
        if (idatform .eq. 1) then
        do i = 1, nvalm 
