function data=perform_model_versus_field_analysis(field_time,field_value, ...
    name,y_label,plot_title,time,value,analysis_type,shift,harm)
%
...
%    saveas(gcf,[name '_wse_box'],'tiffn');
  ...
  elseif(analysis_type==4)
    save_name=[name '_vel_box'];
    print('-r600','-cmyk','-dtiff',save_name);  
    saveas(gcf,[name '_vel_box'],'fig');     
  end
