...
f14_name = 'restored_NEW_Sept26_full_renum_checked.grd';                    % fort.14 name
f13_name = 'restored_7attributes.13';                    % fort.13 name
bbox = [-89.2 -88.0 30.0 30.5];  %If you comment out this line it will default to the entire domain.
...
clear nodes ;%Not used in the script
