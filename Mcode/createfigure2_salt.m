function createfigure2_salt(model_time, model_value, field_time, field_value ...
...
%min_x=datenum('01/01/2004 00:00:00');
%max_x=datenum('01/01/2005 00:00:00');
...
plot(model_time,model_value,'Parent',axes1,'LineWidth',0.5,'DisplayName','Model Data');

%% Create the field time series plot

plot(field_time,field_value,'Parent',axes1,'LineWidth',0.5,'DisplayName','Measured Field Data');
