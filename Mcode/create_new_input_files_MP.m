function create_new_input_files(old_base_file_name,new_base_file_name)
%
%
%
...
%
%   THIS IS TO SET UP HOTSTART FOR MARSH POROSITY (NO DRY NODES)


tic

fid_in_bc=fopen([old_base_file_name '.bc'],'r');
fid_in_hot=fopen([old_base_file_name '.hot'],'r');
...
fid_out_bc=fopen([new_base_file_name '.bc'],'w');
fid_out_hot=fopen([new_base_file_name '.hot'],'w');

old_grid=read_adh_grid([old_base_file_name '.3dm']);
new_grid=read_adh_grid([new_base_file_name '.3dm']);
...
%%%%%%%%%%%%%%%%%%% TOM TO SET UP FOR MARSH POROSITY
...
%%%%%%%%%%%%%%%%%%%%% TOM TO SET UP FOR MARSH POROSITY
                    ...
                    fprintf(fid_out_hot,'%15.8e\n',...
                      max(data{1}(new_match_to_old(y)),0.01));
                 else
                    value1=(weights(y,1) * ...
                        data{1}(closest_nodes(y,1)) +      ...
                        weights(y,2) *     ...
...
%%%%%%%%%%%%%%%%%%%% TOM TO SET UP SALT FOR MARSH POROSITY
