...
%
% H5ATTPUT(HDFFILE,VARNAME,ATTNAME,ATTVALUE) creates/overwrites the attribute
...
%
% H5ATTPUT(HDFFILE,ATTNAME,ATTVALUE) does the same thing, but the complete path
% to the parent object is embedded within ATTNAME.
%
...
if ischar(attvalue)
	...
	dataspace_id = H5S.create_simple ( 1, dims, dims );
end
