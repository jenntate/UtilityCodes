function determine_maximums_zero(basename,attributes,start_time,stop_time)
%
%
...
%     datestr(data.time)
     ...
     loc_dry=find(vel_mag==0.0);
     count=count+1;
     if(dep_check > 0)
       data.dep(loc_dry)=0.0;
     ...
     last_time=data.time; 
     if(wse_check > 0)
       data.wse(loc_dry)=grid.z(loc_dry);
