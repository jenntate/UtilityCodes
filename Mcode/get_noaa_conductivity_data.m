function [data,status] = get_noaa_conductivity_data(stnid,bdate,edate,datumstr,...
...
if (I == 1)
    ...
    type = 'Conductivity';
    type2 = 'Preliminary';
    sensorhist = 'W1';  %Force this option if Preliminary Data
end
...
wlsensorhiststr = ['wl_sensor_hist=',sensorhist];  %6 min or hourly
