     ...
     &               47,46,74,115,117,153,45,72,73,114                /	
      ...
      open(20,FILE='Tfinal_daily.txt',STATUS='OLD',FORM='FORMATTED')
      rewind(20)
      open(21,FILE='Tfinal_hourly.txt',STATUS='OLD',FORM='FORMATTED')
      rewind(21)
...
*     *** read hourly values
 ...
 2000 write(*,*) "Hours Read: ",ih
	  ...
	  write(cdate,'(I8.8)') date(i)
          ...
          write(30,801) 4,5,0,1,0,2,0,1,0,0,0,1,0,0,0,2,0
          do j=1,10
...
C        if(i.ne.ih) then
C          phr=phr+.5
C          write(30,800) cdate(1:2),cdate(3:4),cdate(5:8),phr
C          write(30,801) 4,5,0,1,0,2,0,1,0,0,0,1,0,0,0,2,0 
C          write(30,804) 2,bql_flows(id),4.235,0.0,-1.0,-1.0
C          write(30,805) 1,tide(i)+100.,ocean_sal(id),
C     &                 -1.0,-1.0
C          write(30,806) 1,wspd(i),wdir(i)
C          write(30,807) 14,0.0,0.0
C          write(30,807) 11,wspd(i),wdir(i)
C          write(30,808)
C        endif
      enddo     
      write(30,*)
